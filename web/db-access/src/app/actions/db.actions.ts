...
export class DbActions {
    ...
    public getDbs: (dbs: any) => Action<any> = createAction(DbActions.ADD_DBS);
    public getTables: (tables: any) => Action<any> = createAction(DbActions.ADD_TABLES);
    public getRows: (rows: any) => Action<any> = createAction(DbActions.ADD_ROWS);
    public getFields: (fields: any) => Action<any> = createAction(DbActions.ADD_FIELDS);
